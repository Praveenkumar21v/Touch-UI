...
const Profile = () => {
  ...
  const profileSocialDetails = user?.profile_social_details ? JSON.parse(user.profile_social_details) : {};
  const postCount = profileSocialDetails.post_count || 0;
  const followingCount = profileSocialDetails.following_count || 0;
  const followersCount = profileSocialDetails.followers_count || 0;
          ...
          <div className="back">
            <div className="back-content">
              ...
              <div className="social-details">
                <div className="flex-count-post"><span className="post-count">{postCount}</span> <span className="posts-count">Posts</span></div>
                <div className="flex-count-following"><span className="following-count">{followingCount}</span> <span  className="followings-count">Following</span></div>
                <div className="flex-count-follower"><span className="follower-count">{followersCount}</span> <span className="followers-count">Followers</span></div>
              </div>
            </div>
          </div>
          ...
          <Modal.Body>
            {selectedPost ? (
              <div className="modal-grid">
                ...
                <div className="modal-right" id={selectedPost.caption.length < 10 ? 'more-length-top' : 'more-length-bottom'}>
            ...
            {activeCommentBox ===
              ...
              <div className="highlight-background">
                {selectedPost.caption.length < 10 ? (
                  <div className="cap-count-more" id={JSON.parse(selectedPost?.post_file).length > 1
                    ? "comment-box-with-muliples"
                    : "comment-box-with-singles"}>
                    <textarea
                      className={
                        selectedPost?.comment_count > 0
                          ? "have-comment-box"
                  ...
                  <div className="cap-count-small" id={JSON.parse(selectedPost?.post_file).length > 1
                    ? "comment-box-with-muliple"
                    : "comment-box-with-single"}>
                    <textarea
                      className={
                        selectedPost?.comment_count > 0
                          ? "have-comment-box"
